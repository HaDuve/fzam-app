...
{
    public class CopingLineChart : LineChart
    {
        ...
        protected void DrawAxisLines(SKCanvas canvas, SKSize itemSize, float headerHeight, int width)
        {
            ...
            canvas.DrawLine((xStart + xEnd) / 3, yStart, (xStart + xEnd) / 3, yEnd - 5, whitePaint);
            canvas.DrawLine((xStart + xEnd) * 2 / 3, yStart, (xStart + xEnd) * 2 / 3, yEnd - 5, whitePaint);
        }
    }
}